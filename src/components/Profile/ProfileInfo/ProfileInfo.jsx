...
export default function ProfileInfo() {
	return (
		<div className={s.profile}>
			<div className={s.wallpaper}><img src='https://3dnews.ru/assets/external/illustrations/2017/06/14/953915/01.jpg' alt=''></img></div>
			<div className={s.user}>
				<div className={s.userpic}><img src={ava} alt=''></img></div>
